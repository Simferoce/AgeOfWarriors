...
namespace Game.Modifier
{
    public class ModifierHandler : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            statisticRepository.Add(new StatisticFloat("damage_taken", StatisticDefinitionRegistry.Instance.DamageTaken, 1f, (float baseValue) => baseValue * modifiers.Multiply(StatisticDefinitionRegistry.Instance.DamageTaken)));
