...
namespace Game
{
    ...
    public class SpreadBleedingPerk : CharacterTechnologyPerkDefinition
    {
        public class Modifier : Modifier<Modifier, SpreadBleedingPerk>
        {
            ...
            public Modifier(IModifiable modifiable, SpreadBleedingPerk modifierDefinition, IModifierSource modifierSource) : base(modifiable, modifierDefinition, modifierSource)
            {
            }
        }
