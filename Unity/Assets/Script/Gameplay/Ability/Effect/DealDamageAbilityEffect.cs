...
namespace Game
{
    ...
    public class DealDamageAbilityEffect : AbilityEffect, IAttackSource
    {
        ...
        public override void Apply()
        {
            ...
            Attack attack = Ability.Character.GenerateAttack(damage.GetValueOrDefault(Ability), armorPenetration.GetValueOrDefault(Ability), leach.GetValueOrDefault(Ability), false, target, this);
