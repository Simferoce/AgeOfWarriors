...
namespace Game
{
    public class CharacterHealthBar : MonoBehaviour
    {
        ...
        public void Update()
        {
            ...
            float shieldPercentage = character.Entity.GetCachedComponent<ModifierHandler>().GetModifiers().OfType<ShieldModifierDefinition.Shield>().Sum(x => x.Remaining) / character.MaxHealth;
