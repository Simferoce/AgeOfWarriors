...
namespace Game.Statistics.Definitions
{
    public static class StatisticDefinitionRepository
    {
        ...
        public static StatisticDefinition DefenseFlat => GetDefinition("defense_flat");
        ...
        public static StatisticDefinition ArmorPenetration => GetDefinition("armor_penetration");
